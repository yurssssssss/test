...
<div class="page-wrapper">
  ...
  <aside class="left-sidebar" id="leftSidebar">
    ...
    <div class="sb-brand">
      <img src="/logo.png" alt="PHLCI Logo" style ="background:#fff;padding:4px;border-radius:50px">
      <div>
        ...
        <table class="table table-hover align-middle">
          ...
          <tbody style="font-size:13px">
            ...
            $logs = [
              ...
              ['Apr 8, 2026 – 8:50 AM','Ben Santos','Admin (Gr 8)','Returned Application','Applicant: Maria Lopez (APP031) – Incomplete Requirements, returned for resubmission','warning'],
